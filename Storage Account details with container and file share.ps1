...
[System.Collections.ArrayList]$saUsage = New-Object -TypeName System.Collections.ArrayList
 ...
 foreach ($storageAccount in $storageAccounts) {
   ...
   #list containers
   $conatiners= Get-AzRmStorageShare -ResourceGroupName $storageAccount.ResourceGroupName -StorageAccountName $storageAccount.Name
...
$saUsage | Export-Csv -Path D:\BajajPay_Prod_AzHubFW_fileshare.csv -NoTypeInformation